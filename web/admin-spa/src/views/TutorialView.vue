...
import WorkBuddyTutorial from '@/components/tutorial/WorkBuddyTutorial.vue'
...
const cliTools = [
  ...
  { key: 'workbuddy', name: 'WorkBuddy', icon: 'fas fa-laptop-code', component: WorkBuddyTutorial }
]
