...
class ApiKeyService {
  ...
  async generateApiKey(options = {}) {
    const {
      ...
      preferredClaudeAccountId = null,
      preferredGeminiAccountId = null,
      preferredOpenaiAccountId = null,
      azureOpenaiAccountId = null,
      bedrockAccountId = null, // 添加 Bedrock 账号ID支持
      droidAccountId = null,
      preferredDroidAccountId = null,
    ...
    const keyData = {
      ...
      preferredClaudeAccountId: preferredClaudeAccountId || '',
      preferredGeminiAccountId: preferredGeminiAccountId || '',
      preferredOpenaiAccountId: preferredOpenaiAccountId || '',
      azureOpenaiAccountId: azureOpenaiAccountId || '',
      bedrockAccountId: bedrockAccountId || '', // 添加 Bedrock 账号ID
      droidAccountId: droidAccountId || '',
      preferredDroidAccountId: preferredDroidAccountId || '',
    ...
    return {
      ...
      preferredClaudeAccountId: keyData.preferredClaudeAccountId,
      preferredGeminiAccountId: keyData.preferredGeminiAccountId,
      preferredOpenaiAccountId: keyData.preferredOpenaiAccountId,
      azureOpenaiAccountId: keyData.azureOpenaiAccountId,
      bedrockAccountId: keyData.bedrockAccountId, // 添加 Bedrock 账号ID
      droidAccountId: keyData.droidAccountId,
      preferredDroidAccountId: keyData.preferredDroidAccountId,
